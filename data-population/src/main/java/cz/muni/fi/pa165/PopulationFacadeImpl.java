...
public class PopulationFacadeImpl implements PopulationFacade {
    ...
    public void populate() {
        ...
        event("Victoria becomes Queen", LocalDate.of(1837, 2, 27), "England", "Victoria is named Queen of Great Britain and Ireland.", null, victorian_era);
        event("US Civil War begins", LocalDate.of(1861, 2, 1), "United States", "The US Civil War begins. Also in this year, the Russian serfs were emancipated and Prince Albert died of typhoid.", null, victorian_era);
        event("Queen Victoria Dies", LocalDate.of(1901, 2, 1), "United Kingdom", "No description", null, victorian_era);

        event("Trojan War Begins", LocalDate.of(-1000, 1, 7), "Troy, Turkey", "No Description", null, trojan_war);
        event("Gods begin to take sides", LocalDate.of(-1000, 1, 11), "Troy, Turkey", "Zeus favors the Trojans. He sends a lying dream to Agamemnon that said that he would win if he attacked.", null, trojan_war);
        event("The Trojan Horse", LocalDate.of(-1000, 1, 16), "Troy, Turkey", "Odysseus creates a plan to build a giant wooden horse. He and some other Greeks hide inside of it.", null, trojan_war);
        event("The Greek Army Destroys Troy", LocalDate.of(-1000, 1, 19), "Troy, Turkey", "No Description", null, trojan_war);

        event("Hamlet", LocalDate.of(1599, 10, 14), "United Kingdom", "It is believed Shakespeare began his work on Hamlet this year, which was considered to one of his greatest plays of all times.", null, renaissance_lit);

        event("Oliver Twist", LocalDate.of(1837, 3, 28), "England", "Charles Dickens publishes Oliver Twist", null, victorian_lit);
        event("Alice in Wonderland", LocalDate.of(1865, 5, 6), "United Kingdom", "Lewis Carroll publishes Alice’s Adventures in Wonderland.", null, victorian_lit);
        event("War and Peace", LocalDate.of(1869, 8, 5), "Russia", "In Russia, Leo Tolstoy publishes the text War and Peace. This novel is the study of early 19th-century Russian society and is regarded as one of the world's greatest novels.", null, victorian_lit);
        event("Sherlock Holmes", LocalDate.of(1887, 2, 17), "United Kingdom", "Arthur Conan Doyle writes A Study in Scarlet, introducing Sherlock Holmes to the readers.", null, victorian_lit);
