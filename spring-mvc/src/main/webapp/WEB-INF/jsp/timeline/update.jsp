...
<my:maintemplate title="Update timeline">
    ...
    <jsp:attribute name="body">
        <form:form method="post" action="${pageContext.request.contextPath}/timeline/update"
                   modelAttribute="timeline"
                   cssClass="form-horizontal mt-5 p-5 border col-lg-6 col-md-9 bg-light">
            <h1>Create timeline</h1>

            <c:if test="${not empty update_timeline_failure}">
                <div class="alert alert-danger" role="alert"><c:out value="${update_timeline_failure}"/></div>
            </c:if>
